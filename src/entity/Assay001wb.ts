...
export class Assay001wb {
  ...
  setProperties(assayDTO: AssayDTO) {
    ...
    this.parameterDetail = assayDTO.parameterDetail;
    this.singleValue = assayDTO.singleValue;
    this.unit = assayDTO.unit;
    this.originalPrefixSlno = assayDTO.originalPrefixSlno;
    this.highEndValue = assayDTO.highEndValue;
    this.lowEndValue = assayDTO.lowEndValue;
    this.units = assayDTO.units;
    this.nonNumeric = assayDTO.nonNumeric;
    this.remark = assayDTO.remark;
    this.typeSlno = assayDTO.typeSlno;
    this.cell = assayDTO.cell;
    this.cellDetail = assayDTO.cellDetail;
    this.organ = assayDTO.organ;
    this.organDetail = assayDTO.organDetail;
    this.species = assayDTO.species;
    this.speciesDetail = assayDTO.speciesDetail;
    this.gender = assayDTO.gender;
    this.ageGroup = assayDTO.ageGroup;
    this.target = assayDTO.target;
    this.targetVersion = assayDTO.targetVersion;
    this.targetStatus = assayDTO.targetStatus;
    this.collectionId1 = assayDTO.collectionId1;
    this.original = assayDTO.original;
    this.acronym = assayDTO.acronym;
    this.organism = assayDTO.organism;
    this.variant = assayDTO.variant;
