...
export class ReportsService {
    ...
    async downloadExcel(@Req() request: Request, @Res() response: Response) {
        ...
        if (assays.length < 0) {
            ...
            for (let i = 0; i < assays.length; i++) {
                ...
                worksheet.getCell('A' + temp).value = assays[i].ligandSlno2.tanNumber;
                ...
                worksheet.getCell('B' + temp).value = assays[i].ligandSlno2.ligandUri;
                ...
                worksheet.getCell('C' + temp).value = assays[i].ligandSlno2.ligandVersionSlno2.ligandVersion;
                ...
                worksheet.getCell('D' + temp).value = assays[i].targetStatus;
                ...
                worksheet.getCell('F' + temp).value = assays[i].ligandSlno2.ligandTypeSlno2.ligandtype;
                ...
                worksheet.getCell('G' + temp).value = assays[i].ligandSlno2.identifier1;
                ...
                worksheet.getCell('H' + temp).value = assays[i].ligandSlno2.identifier2;
                ...
                worksheet.getCell('I' + temp).value = assays[i].ligandSlno2.identifier3;
                ...
                worksheet.getCell('J' + temp).value = assays[i].ligandSlno2.collectionId;
                ...
                worksheet.getCell('K' + temp).value = assays[i].ligandSlno2.ligandDetail;
                ...
                worksheet.getCell('L' + temp).value = assays[i].ligandSlno2.locator;
                ...
                worksheet.getCell('N' + temp).value = assays[i].ligandSlno2.tanNumber;
                ...
                worksheet.getCell('O' + temp).value = assays[i].ligandSlno2.tanNumber;
                ...
                worksheet.getCell('P' + temp).value = assays[i].ligandSlno2.collectionId;
                ...
                worksheet.getCell('BH' + temp).value = assays[i].ligandSlno2.diseaseName1;
                ...
                worksheet.getCell('BI' + temp).value = assays[i].ligandSlno2.diseaseName2;
                ...
                worksheet.getCell('BJ' + temp).value = assays[i].ligandSlno2.diseaseName3;
                ...
                worksheet.getCell('BN' + temp).value = assays[i].collectionId1;
                ...
                worksheet.getCell('BO' + temp).value = assays[i].original;
                ...
                worksheet.getCell('BP' + temp).value = assays[i].acronym;
                ...
                worksheet.getCell('BQ' + temp).value = assays[i].organism;
                ...
                worksheet.getCell('BR' + temp).value = assays[i].variant;
    ...
    // -------------------------------------------Assay-------------------------------------
                ...
                worksheet.getCell('W' + temp).value = assays[i].procedure;
                ...
                worksheet.getCell('AB' + temp).value = assays[i].ligandLvalue;
                ...
                worksheet.getCell('AD' + temp).value = assays[i].conditionType;
                ...
                worksheet.getCell('AE' + temp).value = assays[i].conditionMaterial;
                ...
                worksheet.getCell('AF' + temp).value = assays[i].conditionMaterialid;
                ...
                worksheet.getCell('AG' + temp).value = assays[i].singleCondition;
                ...
                worksheet.getCell('AH' + temp).value = assays[i].singleUnit;
                ...
                worksheet.getCell('AI' + temp).value = assays[i].highCondition;
                ...
                worksheet.getCell('AJ' + temp).value = assays[i].lowCondition;
                ...
                worksheet.getCell('AK' + temp).value = assays[i].highLowUnit;
...
// --------------------------------------Measurement------------------------------
            ...
            worksheet.getCell('AL' + temp).value = assays[i].dataLocator;
